...
public class Router {
    ...
    public void showWebView(@NonNull Activity activity, @NonNull String url, @Nullable String dialogTitle) {
        activity.startActivity(WebViewActivity.newIntent(activity, url, dialogTitle));
    }
}
